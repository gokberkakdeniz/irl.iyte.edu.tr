    ...
    return (
      <>
       <IRLBase year="2012" {...this.props}>
          ...
          <ol>
            <li>Midas Erdem Tatlı - İstanbul Kültür Üniversitesi</li>
            <li>S.W.A.R.M Görkem Sarıgül - İstanbul Kültür Üniversitesi</li>
            <li>Formula Car Visual Mehmet Cahit Özdemir - İstanbul Teknik Üniversitesi</li>
          </ol>

          <b>Arazi Kategorisi</b>
          <ol>
            <li>Celal Alp Can Ağaya - Celal Bayar Üniversitesi</li>
            <li>Challenger Sabri Can Bozdemir</li>
            <li>Destur Özkan Kara</li>
          </ol>

          <b>Mini Sumo</b>
          <ol>
            <li>Umut İbrahim Tuna</li>
            <li>Goran Ahmet Kazan</li>
            <li>Junior Fast Rabia Gülbike Kaya</li>
          </ol>

          <b>Sumo</b>
          <ol>
            <li>Başkan - Süleyman Demirel Üniversitesi</li>
            <li>İsmini Vermek İstemiyorum - Uludağ Üniversitesi</li>
            <li>Hurşit - Yıldız Teknik Üniversitesi</li>
          </ol>

          <b>Çizgi İzleyen</b>
          <ol>
            <li>Master of Lines - Ediz Ağarer</li>
            <li>Road Runner - Osman Demirci</li>
            <li>Anadolu Kaplanı - Muhsin Ağbaş</li>
          </ol>

          <b>Kibele RoboWorker</b>
          <ol>
          ...
          <b>Yangın Söndüren</b>
          <ol>
            <li>Hazal Süleymanoğlu ve ekibi</li>
          </ol>
       </IRLBase>
      </>
    )
